"""
Schemas for structured metadata extraction in the RAG pipeline.

Defines enums and Pydantic models used to normalize and validate
company, document type, fiscal year, and fiscal quarter filters.
"""
...
class ChunkMetadata(BaseModel):
    ...
    """
    Structured metadata schema for RAG query filtering.

    Used by LLMs to extract normalized filters that can be
    directly applied to vector store metadata queries.
    """
