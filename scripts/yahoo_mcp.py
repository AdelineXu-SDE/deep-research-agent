"""
Yahoo Finance MCP adapter for live financial data access.

Integrates the Yahoo Finance MCP server with LangChain agents,
providing real-time market data, news, and financial statements.
"""
...
async def finance_research(query):
    """
    Run a Yahoo Finance-backed agent to answer live market queries.

    Fetches real-time stock data, news, and financial information
    via the Yahoo Finance MCP server.
    """
